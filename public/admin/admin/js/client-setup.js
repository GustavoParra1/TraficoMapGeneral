  ...
  static showSetupForm() {
    const form = `
      <div class="card mt-4" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
        ...
        <div class="card-body">
          <p class="text-muted mb-3">Crea un usuario para que el cliente acceda a su panel</p>
          <form id="setupClientForm">
            <div class="mb-3">
              <label class="form-label">Email del Cliente *</label>
              <input type="email" class="form-control" id="setupEmail" placeholder="admin@laplatamaps.com.ar" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Contraseña Temporal *</label>
              <input type="password" class="form-control" id="setupPassword" placeholder="Ej: Municipio123!" required>
            </div>
            <button type="submit" class="btn btn-primary">
              <i class="bi bi-check-circle"></i> Crear Usuario para Cliente
            </button>
          </form>
